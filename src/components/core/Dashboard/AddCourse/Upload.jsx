...
export default function Upload({
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div
        className={`${
          isDragActive ? "bg-gray-200" : "bg-richblack-150"
        } flex min-h-[250px] cursor-pointer items-center justify-center rounded-md border-2 border-dotted border-gray-600`}
      >
        {previewSource ? (
          ...
          >
            ...
            <p className="mt-2 max-w-[200px] text-center text-sm text-gray-500">
              ...
              <span className="font-semibold text-blue-600">Browse</span> a
              file
            </p>
