  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div>
          <div className="my-4 flex h-[450px] space-x-4">
            ...
            {totalAmount > 0 || totalStudents > 0 ? (
              ...
              <div className="flex-1 rounded-md bg-gray-50 p-6">
                <p className="text-lg font-bold text-gray-900">Visualize</p>
                <p className="mt-4 text-xl font-medium text-gray-9000">
                  Not Enough Data To Visualize
                </p>
              </div>
            )}
            {/* Total Statistics */}
            <div className="flex min-w-[250px] flex-col rounded-md bg-gray-50 p-6">
              <p className="text-lg font-bold text-gray-900">Statistics</p>
              <div className="mt-4 space-y-4">
                <div>
                  <p className="text-lg text-gray-500">Total Courses</p>
                  <p className="text-3xl font-semibold text-gray-9000">
                    {courses.length}
                  </p>
                </div>
                <div>
        ...
        <div className="mt-20 rounded-md bg-gray-50 p-6 py-20">
