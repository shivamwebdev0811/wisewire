    ...
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center">
      {loading ? (
        ...
        <div className="max-w-[500px] p-4 lg:p-8">
          <h1 className="text-[1.875rem] font-semibold leading-[2.375rem] text-gray-900">
            Choose new password
          </h1>
          ...
          <form onSubmit={handleOnSubmit}>
            ...
            <button
              type="submit"
              className="mt-6 w-full rounded-[8px] bg-blue-600 py-[12px] px-[12px] font-medium text-gray-100"
            >
              Reset Password
            </button>
          </form>
